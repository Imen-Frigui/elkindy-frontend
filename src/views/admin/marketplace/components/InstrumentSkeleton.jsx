      ...
      <div className=" h-full w-full animate-pulse ">
        ...
        <div className="flex w-full items-center justify-between">
          <div className="w-3/4 space-y-4">
            <div className="h-5 w-1/4 rounded-md bg-indigo-100 "></div>
            <div className="h-4 w-2/3 rounded-md bg-indigo-100 "></div>
            <div className="h-8 w-28 rounded-md bg-indigo-100 "></div>
          </div>
