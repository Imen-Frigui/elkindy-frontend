...
import Observationclass from './observation.jsx';
import ClassBanner from './table.jsx';


const TeacherBanner = ({filteredStudents ,ButtonComponent ,setIsDrawerOpen2 , setstudents , setUserName ,setIsDrawerOpen ,setstudentName , AllClasses , setIsDrawerOpen4}) => {

  const [isDrawerOpenAdd, setIsDrawerOpenAdd] = useState(false);
  const [isDrawerOpenexam, setIsDrawerOpenexam] = useState(false);
  const [isDrawerOpenClass, setIsDrawerOpenClass] = useState(false)
  return (
          ...
          <div id="drawer-create-course" className="fixed inset-0 flex items-center justify-center z-50 overflow-auto backdrop-blur-md">
            <div className="overflow-hidden shadow sm:rounded-lg mt-4 w-3/6 relative">
              ...
              <div className="z-10 relative">
                <TableEvalution filteredStudents={filteredStudents} ButtonComponent={ButtonComponent} setIsDrawerOpen2={setIsDrawerOpen2} setstudents={setstudents} setUserName={setUserName} setIsDrawerOpen={setIsDrawerOpen} setstudentName={setstudentName} AllClasses={AllClasses} setIsDrawerOpen4={setIsDrawerOpen4} />
              </div>
            </div>
            {/* Close button */}
  ...
  <h4 className="mb-[14px] max-w-full text-xl font-bold text-white md:w-[64%] md:text-3xl md:leading-[42px] lg:w-[46%] xl:w-[85%] 2xl:w-[75%] 3xl:w-[52%]">
    ...
    <p className="mb-[40px] max-w-full text-base font-medium text-gray-100 md:w-[64%] lg:w-[40%] xl:w-[72%] 2xl:w-[60%] 3xl:w-[45%]"> 
        Explore All the Observations
    </p>
    <div className="mt-[36px] flex items-center justify-center gap-4 sm:justify-start 2xl:gap-10">

    

    <button className="text-black linear rounded-xl bg-white px-4 py-2 text-center text-base font-medium transition duration-200 hover:!bg-white/80 active:!bg-white/70" onClick={() => setIsDrawerOpenClass(true)}>
    Observations
    ...
    <div id="drawer-create-course" className="fixed inset-0 flex items-center justify-center z-50 overflow-auto backdrop-blur-md">
      <div className="overflow-hidden shadow sm:rounded-lg mt-4 w-3/6 relative">
        ...
        <div className="z-10 relative">
          ...
          <Observationclass setIsDrawerOpenClass={setIsDrawerOpenClass} />
          <div className="flex justify-end">
                                <button
                                    onClick={() => setIsDrawerOpenClass(false)}
