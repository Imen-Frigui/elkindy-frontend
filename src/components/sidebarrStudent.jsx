...
function SideBarrStudent({ open, onClose }) {
  ...
  return (
    <div
      className={`sm:none duration-175 linear fixed p-3 w-auto left-0 !z-50 flex h-screen items-center justify-center bg-indigo-50 transition-all dark:!bg-navy-900 md:!z-50 lg:!z-50 xl:!z-0 ${open ? "translate-x-0 shadow-md" : "-translate-x-96 shadow-none"
        }`}
    >
      <span
      ...
      <div className="ml-6 flex w-10 flex-col items-center space-y-10 px-5 py-6">
